...
function love.update(dt)
    if gameState == 'serve' then
        -- make ai paddle reset to middle when gameplay state begins to resolve funky business inbetween rounds
...
-- replace player 2 with a basic ai which will always return the ball
player2.dy = ball.dy
